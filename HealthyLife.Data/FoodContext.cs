...
namespace HealthyLife.Data
{
    public class FoodContext : DbContext
    {
        ...
        {
            // Seeding
            var i_egg = new Ingredient { Id = 1, Name = "Large Egg", CaloryIn100G = 143, CarboHydrateIn100G = 0.7, FatIn100G = 9.5, ProteinIn100G = 13 };
            var i_salt = new Ingredient { Id = 2, Name = "Salt", CaloryIn100G = 0, CarboHydrateIn100G = 0, FatIn100G = 0, ProteinIn100G = 0 };
